...
![Version: 0.12.10-1.0.1](https://img.shields.io/badge/Version-0.12.10--1.0.1-informational?style=flat-square)
...
```console
$ helm install my-release oci://quay.io/okdp/charts/superset --version 0.12.10-1.0.1
```
...
[]
		...
		<tr>
			<td id="superset--tolerations"><a href="./values.yaml#L1136">superset.tolerations</a></td>
			<td>
list
</td>
			<td><div style="max-width: 300px;">
...
[]
		...
		<tr>
			<td id="superset--topologySpreadConstraints"><a href="./values.yaml#L1141">superset.topologySpreadConstraints</a></td>
			<td>
list
</td>
			<td><div style="max-width: 300px;">
